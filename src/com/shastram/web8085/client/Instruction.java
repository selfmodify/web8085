...
public class Instruction {
    ...
    public static OneInstruction[] allInstructions = new OneInstruction[] {
            ...
            new OneInstruction("inr", "inr b", noOperand, MicroCode.inr),
            new OneInstruction("dcr", "dcr b", noOperand, MicroCode.dcr),
            ...
            new OneInstruction("dad", "dad b", noOperand, MicroCode.dad),
            ...
            new OneInstruction(".break", "invalid", noOperand, MicroCode.breakRunner),
            ...
            new OneInstruction("inr", "inr d", noOperand, MicroCode.inr),
            //21
            new OneInstruction("dcr", "dcr d", noOperand, MicroCode.dcr),
            new OneInstruction("mvi", "mvi d", byteOperand, MicroCode.mvi),
            new OneInstruction("ral", "ral", noOperand, MicroCode.nop),
            new OneInstruction("", "invalid", noOperand, MicroCode.nop),
            new OneInstruction("dad", "dad d", noOperand, MicroCode.dad),
            ...
            new OneInstruction("inr", "inr h", noOperand, MicroCode.inr),
            new OneInstruction("dcr", "dcr h", noOperand, MicroCode.dcr),
            new OneInstruction("mvi", "mvi h", byteOperand, MicroCode.mvi),
            new OneInstruction("daa", "daa", noOperand, MicroCode.nop),
            //41
            new OneInstruction("", "invalid", noOperand, MicroCode.nop),
            new OneInstruction("dad", "dad h", noOperand, MicroCode.dad),
            ...
            new OneInstruction("inr", "inr m", noOperand, MicroCode.inr),
            new OneInstruction("dcr", "dcr m", noOperand, MicroCode.dcr),
            new OneInstruction("mvi", "mvi m", byteOperand, MicroCode.mvi),
            new OneInstruction("stc", "stc", noOperand, MicroCode.stc),
            new OneInstruction("", "invalid", noOperand, MicroCode.nop),
            new OneInstruction("dad", "dad sp", noOperand, MicroCode.dad),
            ...
            new OneInstruction("add", "add b", noOperand, MicroCode.add),
            new OneInstruction("add", "add c", noOperand, MicroCode.add),
            new OneInstruction("add", "add d", noOperand, MicroCode.add),
            new OneInstruction("add", "add e", noOperand, MicroCode.add),
            new OneInstruction("add", "add h", noOperand, MicroCode.add),
            new OneInstruction("add", "add l", noOperand, MicroCode.add),
            new OneInstruction("add", "add m", noOperand, MicroCode.add),
            new OneInstruction("add", "add a", noOperand, MicroCode.add),

            new OneInstruction("adc", "adc b", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc c", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc d", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc e", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc h", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc l", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc m", noOperand, MicroCode.adc),
            new OneInstruction("adc", "adc a", noOperand, MicroCode.adc),

            new OneInstruction("sub", "sub b", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub c", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub d", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub e", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub h", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub l", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub m", noOperand, MicroCode.sub),
            new OneInstruction("sub", "sub a", noOperand, MicroCode.sub),

            new OneInstruction("sbb", "sbb b", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb c", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb d", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb e", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb h", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb l", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb m", noOperand, MicroCode.sbb),
            new OneInstruction("sbb", "sbb a", noOperand, MicroCode.sbb),
            ...
            new OneInstruction("aci", "aci", byteOperand, MicroCode.aci),
