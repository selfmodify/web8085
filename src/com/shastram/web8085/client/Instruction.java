...
public class Instruction {
    ...
    public static OneInstruction[] allInstructions = new OneInstruction[] {
            ...
            new OneInstruction(0xb8, "cmp", "cmp b", noOperand, MicroCode.nop),
            new OneInstruction(0xb9, "cmp", "cmp c", noOperand, MicroCode.nop),
            new OneInstruction(0xba, "cmp", "cmp d", noOperand, MicroCode.nop),
            new OneInstruction(0xbb, "cmp", "cmp d", noOperand, MicroCode.nop),
            new OneInstruction(0xbc, "cmp", "cmp h", noOperand, MicroCode.nop),
            new OneInstruction(0xbd, "cmp", "cmp l", noOperand, MicroCode.nop),
            new OneInstruction(0xbe, "cmp", "cmp m", noOperand, MicroCode.nop),
            new OneInstruction(0xbf, "cmp", "cmp a", noOperand, MicroCode.nop),
            ...
            new OneInstruction(0xfe, "cpi", "cpi", byteOperand, MicroCode.nop),
