...
public class MicrocodeTable {
    ...
    public static MicroCode.OneInstruction[] table = new MicroCode.OneInstruction[] {
            ...
            new MicroCode.OneInstruction(0xc0, "rnz", "rnz", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xc1, "pop", "pop b", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xc2, "jnz", "jnz", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xc3, "jmp", "jmp", MicroCode.wordOperand, MicroCode.jmp),
            new MicroCode.OneInstruction(0xc4, "cnz", "cnz", MicroCode.wordOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xd0, "rnc", "rnc", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xd1, "pop", "pop d", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xd2, "jnc", "jnc", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xd3, "out", "out", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xd4, "cnc", "cnc", MicroCode.noOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xd8, "rc", "rc", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xd9, "", "invalid", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xda, "jc", "jc", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xdb, "in", "in", MicroCode.byteOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xdc, "cc", "cc", MicroCode.wordOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xe0, "rpo", "rpo", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xe1, "pop", "pop h", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xe2, "jpo", "jpo", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xe3, "xthl", "xthl", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xe4, "cpo", "cpo", MicroCode.wordOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xe8, "rep", "rep", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xe9, "pchl", "pchl", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xea, "jpe", "jpe", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xeb, "xchg", "xchg", MicroCode.noOperand, MicroCode.xchg),
            new MicroCode.OneInstruction(0xec, "cpe", "cpe", MicroCode.wordOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xf0, "rp", "rp", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xf1, "pop", "pop psw", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xf2, "jp", "jp", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xf3, "di", "di", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xf4, "cp", "cp", MicroCode.wordOperand, MicroCode.nop),
            ...
            new MicroCode.OneInstruction(0xf8, "rm", "rm", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xf9, "sphl", "sphl", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xfa, "jm", "jm", MicroCode.wordOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xfb, "ei", "ei", MicroCode.noOperand, MicroCode.nop),
            new MicroCode.OneInstruction(0xfc, "cm", "cm", MicroCode.wordOperand, MicroCode.nop),
